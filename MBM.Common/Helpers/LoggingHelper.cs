...
namespace MBM.Common.Helpers
{
    public static class LoggingHelper
    {
        ...
        /// <summary>
        /// Adjust Console log level according to the environment
        /// </summary>
        public static void AdjustConsoleLogLevel(IWebHostEnvironment environment)
        {
            if (ApplicationConstants.EnvironmentName != environment.EnvironmentName)
                throw new ArgumentException("Environment variable configuration is invalid.");

            ApplicationConstants.ConsoleLogLevel.MinimumLevel = environment.IsDevelopment()
